...
<div class="eventos-registro">
    ...
    <main class="eventos-registro__listado">
        ...
        <div class="eventos-registro__grid">
            <?php foreach($eventos['conferencias_v'] as $conferencia) { ?>
        ...
        <div class="eventos-registro__grid">
            <?php foreach($eventos['conferencias_s'] as $conferencia) { ?>
                <?php include __DIR__ . '/evento.php' ?>
            <?php } ?>
        </div>
        ...
        <div class="eventos-registro__grid eventos--workshops">
            <?php foreach($eventos['workshops_v'] as $conferencia) { ?>
                <?php include __DIR__ . '/evento.php' ?>
            <?php } ?>
        </div>
        ...
        <div class="eventos-registro__grid eventos--workshops">
            <?php foreach($eventos['workshops_s'] as $conferencia) { ?>
                <?php include __DIR__ . '/evento.php' ?>
            <?php } ?>
        </div>
    </main>
    ...
    <aside class="registro-aside">
        ...
        <div class="registro-aside__regalos">
            <label for="regalos" class="registro-aside__label">Selecciona un Regalo</label>
            <select id="regalo" class="registroa-aside__select">
