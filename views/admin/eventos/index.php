            ...
            <tbody class="table__tbody">
                <?php foreach($eventos as $evento){ ?>
                    <tr class="table__tr">
                        ...
                        <td class="table__td"><?php echo $evento->categoria; ?></td>
                        <td class="table__td"><?php echo $evento->dia . ' (' . $evento->hora .')'; ?></td>
                        <td class="table__td"><?php echo $evento->ponente; ?></td>
                        <td class="table__td--acciones">
                            <a class="table__accion table__accion--editar" href="/admin/eventos/editar?id=<?php echo $evento->id ?>" class="table__accion">
